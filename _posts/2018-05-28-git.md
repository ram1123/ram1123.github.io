...
description: "Notes on using Git for version control — branching, merging, rebasing, and common workflows."
---
...
2. Git stash: [link](https://git-scm.com/book/en/v2/Git-Tools-Stashing-and-Cleaning)

3. Debugging with git: [link](https://git-scm.com/book/en/v2/Git-Tools-Debugging-with-Git)
