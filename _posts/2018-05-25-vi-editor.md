...
description: "Quick-reference guide to the vi/vim editor — navigation, editing, search, and essential commands."
---
...
**_Note that the commands in `vi` must be entered in Command mode_**
