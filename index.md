...
<div class="blurb">
    ...
    <p>
        Currently, I continued working on the physics analysis with full run-2 data. As well as on detector side, I am working on the development on XDAQ for GE1/1 detector (Presently, I am in learning phase) and ageing and discharge studies of the GE2/1 detector for the phase-2 upgrade.
    </p>
    <p>
